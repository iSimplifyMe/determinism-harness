...
set -u
source ~/.config/openai/credentials.env; OPENAI_BASE_URL="https://api.openai.com/v1"; BEDROCK_API_KEY="$OPENAI_API_KEY"
SP="/private/tmp/claude-501/-Users-jelstner/4316d3c5-8bb4-4136-9f24-6a877a6bf1bf/scratchpad"
OUT="$SP/param_probes_door3"
mkdir -p "$OUT"
...
B='{"model":"gpt-5.6-sol","input":"Reply with exactly: OK","max_output_tokens":512'
echo "=== matrix ==="
call base        "$B}"
...
P='{"model":"gpt-5.6-sol","input":"How many prime numbers are there strictly between 1000 and 1100? Answer with just the number.","max_output_tokens":16000'
